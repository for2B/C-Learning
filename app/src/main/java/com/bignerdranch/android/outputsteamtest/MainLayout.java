            ...
            public void onClick(View view) {
                switch (view.getId()) {
                    case R.id.book_button:
                        Toast.makeText(MainLayout.this, "Book", Toast.LENGTH_SHORT).show();
                        Intent intentbook = new Intent(MainLayout.this,BookActivity.class);
                        startActivity(intentbook);
                        break;
                    case R.id.vedio_button:
                        Intent intentvedio = new Intent(MainLayout.this,vedio.class);
                        startActivity(intentvedio);
                        Toast.makeText(MainLayout.this, "Vedio", Toast.LENGTH_SHORT).show();
                        break;
